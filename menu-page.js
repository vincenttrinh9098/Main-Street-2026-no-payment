...
{ category: "Smoothies", items: [
  { name: "Banana Berry Smoothie", desc: "Strawberry, banana &  non-fat yogurt/ice cream", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
  { name: "Berry Sunrise Smoothie", desc: "Strawberry, raspberry, &  banana ", price: "$6.50", image: "" , optionsPreset: "milkTeaToppings"},
  { name: "Chocolate Shake Smoothie", desc: "Chocolate & Ice cream", price: "$6.50", image: "" , optionsPreset: "milkTeaToppings"},
  { name: "Mocha Blast Smoothie", desc: "Expresso, ice cream &  chocolate", price: "$6.50", image:"", optionsPreset: "milkTeaToppings"},
  { name: "Jamaican Dream Smoothie", desc: "Pineapple, coconut, banana, mango, strawberry & non-fat yogurt/ice cream", price: "$6.50", image: "" , optionsPreset: "milkTeaToppings"},
  { name: "Lemony Raspberry Smoothie", desc: "Lemon &  raspberry blended", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
  { name: "Orange Dream Smoothie", desc: "Pineapple, orange & ice cream", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
  { name: "Oreo Blast Smoothie", desc: "Chocolate, oreo, & non-fat yogurt/ice cream blended smoothie", price: "$6.50", image: "" , optionsPreset: "milkTeaToppings"},
  { name: "Peanut Butter Banana Smoothie", desc: "Peanut butter, banana smoothie blend", price: "$6.50", image:""  , optionsPreset: "milkTeaToppings"},
  { name: "Purple Rain Smoothie", desc: "Raspberries blended", price: "$6.50", image:  "", optionsPreset: "milkTeaToppings"},
  { name: "Malibu Sunset", desc: "Pineapple, orange, &  banana smoothie", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
  { name: "Pina Colada", desc: "Pineapple, coconut, & non-fat yogurt", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
  { name: "Raspberry Crush", desc: "Raspberries & non-fat yogurt/ice cream", price: "$6.50", image:"" , optionsPreset: "milkTeaToppings"},
  { name: "Lava Flow Smoothie", desc: "Pineapple, coconut, banana & strawberry", price: "$6.50", image: "", optionsPreset: "milkTeaToppings"},
